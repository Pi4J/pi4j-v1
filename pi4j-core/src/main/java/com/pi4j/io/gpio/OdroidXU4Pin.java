...
public class OdroidXU4Pin extends PinProvider {
    ...
    protected static Pin createDigitalPinNoEdge(int address, String name, EnumSet<PinPullResistance> resistance) {
        return createDigitalPin(OdroidGpioProvider.NAME, address, name, resistance, EnumSet.noneOf(PinEdge.class));
    }

    protected static Pin createDigitalPinNoEdge(int address, String name) {
        return createDigitalPin(OdroidGpioProvider.NAME, address, name, EnumSet.noneOf(PinEdge.class));
    }
    ...
    protected static Pin createDigitalAndPwmPinNoEdge(int address, String name) {
        return createDigitalAndPwmPin(OdroidGpioProvider.NAME, address, name, EnumSet.noneOf(PinEdge.class));
    }
}
