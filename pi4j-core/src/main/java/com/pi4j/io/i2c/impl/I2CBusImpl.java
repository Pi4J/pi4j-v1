...
public class I2CBusImpl implements I2CBus {
     ...
     *
     * @param address address of i2c device (7-bit address only: 0-177)
     *
    ...
    public I2CDevice getDevice(int address) throws IOException {
        ...
        if(address < 0 || address > 0x7F)
            throw new IOException("I2C device address is out of bounds; valid range=(0-177); ADDRESS=" + address);
