 ...
 * FILENAME      :  OrangePiZeroSystemInfoProvider.java
 *
...
/**
 * OrangePiZero platform specific implementation of the SystemInfoProvider interface.
 */
public class OrangePiZeroSystemInfoProvider extends DefaultSystemInfoProvider implements SystemInfoProvider {
    ...
    public SystemInfo.BoardType getBoardType() throws IOException, InterruptedException, UnsupportedOperationException {
        return SystemInfo.BoardType.OrangePi_Zero;
    }
