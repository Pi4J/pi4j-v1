 ...
 * 
 * @see com.pi4j.i2c.devices.microchip.potentiometers.MCP4561
 * @see com.pi4j.i2c.devices.microchip.potentiometers.MCP4651
...
public abstract class PotentiometerImpl
	 ...
	 */
	public boolean isChannelSupportedByDevice(final Channel channel) {
		
		if (channel == null) {
			return false;
		}
		
		for (final Channel supportedChannel : getSupportedChannelsByDevice()) {
