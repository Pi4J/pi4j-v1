 ...
 */
public class MCP4641 extends PotentiometerImpl {
	...
	public MCP4641(final I2CBus i2cBus, final boolean pinA0,
			...
			final Channel channel, final NonVolatileMode nonVolatileMode)
			throws IOException {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			final MCP4641 a = new MCP4641(
					bus, false, false, false, Channel.A, NonVolatileMode.VOLATILE_ONLY);
			final MCP4641 b = new MCP4641(
					bus, false, false, false, Channel.B, NonVolatileMode.VOLATILE_ONLY);
