...
enum DeviceControllerChannel {
	...
	A(DeviceController.MEMADDR_WIPER0, DeviceController.MEMADDR_WIPER0_NV, DeviceController.TCON_RH0HW,
			DeviceController.TCON_RH0A, DeviceController.TCON_RH0B, DeviceController.TCON_RH0W),
	B(DeviceController.MEMADDR_WIPER1, DeviceController.MEMADDR_WIPER1_NV, DeviceController.TCON_RH1HW,
			DeviceController.TCON_RH1A, DeviceController.TCON_RH1B, DeviceController.TCON_RH1W);
	...
	private DeviceControllerChannel(byte volatileMemoryAddress, byte nonVolatileMemoryAddress,
