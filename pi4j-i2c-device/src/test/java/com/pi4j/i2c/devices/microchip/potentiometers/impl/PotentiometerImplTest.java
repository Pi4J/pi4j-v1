...
import com.pi4j.i2c.devices.microchip.potentiometers.impl.DeviceControllerDeviceStatus;
import com.pi4j.i2c.devices.microchip.potentiometers.impl.DeviceControllerFactory;
...
import com.pi4j.i2c.devices.microchip.potentiometers.impl.PotentiometerImpl.NonVolatileMode;
...
public class PotentiometerImplTest {
	...
	class TestableMCP45xxMCP46xxPotentiometer
		...
		public Channel[] getSupportedChannelsByDevice() {
			return new Channel[] { Channel.A, Channel.B };
		}
	...
	public void testIsChannelSupportedByDevice() {
		...
		boolean supported2 = potiA.isChannelSupportedByDevice(Channel.A);
		assertTrue("'isChannelSupported(Channel.A) must be true but wasn't!", supported2);

		boolean supported3 = potiA.isChannelSupportedByDevice(Channel.C);
