...
public class MicrochipPotentiometerMiscTest {
	...
	public void testChannel() {
		...
		assertEquals("Unexpected result from calling 'MicrochipPotentiometerChannel.A.toString()'!",
				"com.pi4j.component.potentiometer.impl.microchip.MicrochipPotentiometerChannel.A", toStringA);
		...
		assertEquals("Unexpected result from calling 'MicrochipPotentiometerChannel.B.toString()'!",
				"com.pi4j.component.potentiometer.impl.microchip.MicrochipPotentiometerChannel.B", toStringB);
	...
	public void testDeviceStatus() {
		...
		assertEquals("Unexpected result from calling 'toString()'!",
				"com.pi4j.component.potentiometer.impl.microchip.MicrochipPotentiometerDeviceStatus{\n"
				+ "  eepromWriteActive='false',\n"
				+ "  eepromWriteProtected='true',\n"
				+ "  wiperLockChannel='com.pi4j.component.potentiometer.impl.microchip.MicrochipPotentiometerChannel.A',\n"
	...
	public void testTerminalConfiguration() {
		...
		assertNotNull("result of 'toString()' is null!", toString);
		assertEquals("Unexpected result from calling 'toString()'!",
				"com.pi4j.component.potentiometer.impl.microchip.MicrochipPotentiometerTerminalConfiguration{\n"
				+ "  channel='com.pi4j.component.potentiometer.impl.microchip.MicrochipPotentiometerChannel.A',\n"
