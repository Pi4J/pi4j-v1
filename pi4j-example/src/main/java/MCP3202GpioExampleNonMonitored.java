 ...
 * FILENAME      :  MCP3202GpioExampleNonMonitored.java
 *
...
import com.pi4j.gpio.extension.mcp.MCP3202GpioProvider;
import com.pi4j.gpio.extension.mcp.MCP3202Pin;
 ...
 * for analog output pin using the MCP3202 ADC chip.  This example
 * configures the MCP3202 without background monitoring and eventing.
 * </p>
 *
 * <p>
 * This GPIO provider implements the MCP3202 12-Bit Analog-to-Digital Converter (ADC) as native Pi4J GPIO pins.
 * </p>
 *
 * <p>
 * The MCP3202 is connected via SPI connection to the Raspberry Pi and provides 2 GPIO analog input pins.
 * </p>
 *
 * @author Christian Wehrli, Robert Savage, Benny Megidish
 */
public class MCP3202GpioExampleNonMonitored {

    public static void main(String args[]) throws Exception {

        System.out.println("<--Pi4J--> MCP3202 ADC Example (NON-MONITORED) ... started.");

        // Create gpio controller
        final GpioController gpio = GpioFactory.getInstance();

        // Create custom MCP3202 analog gpio provider
        // we must specify which chip select (CS) that that ADC chip is physically connected to.
        final AdcGpioProvider provider = new MCP3202GpioProvider(SpiChannel.CS0,
        ...
        // Provision gpio analog input pins for all channels of the MCP3202.
        // (you don't have to define them all if you only use a subset in your project)
        final GpioPinAnalogInput inputs[] = {
                gpio.provisionAnalogInputPin(provider, MCP3202Pin.CH0, "MyAnalogInput-CH0"),
                gpio.provisionAnalogInputPin(provider, MCP3202Pin.CH1, "MyAnalogInput-CH1")
        };
        ...
        for (int count = 0; count < 600; count++) {
            ...
            System.out.println("<MCP3202 VALUES> " + sb.toString());
        ...
        System.out.println("Exiting MCP3202GpioExampleNonMonitored");
    }
}
