 ...
 * for GPIO pin state changes on the OrangePiZero.
 *
...
public class GpioListenAllExample {
    ...
    public static void main(String args[]) throws InterruptedException, PlatformAlreadyAssignedException {
        ...
        GpioPinDigitalInput[] event_pins = {
                gpio.provisionDigitalInputPin(OrangePiZeroPin.GPIO_00, pull),
                gpio.provisionDigitalInputPin(OrangePiZeroPin.GPIO_01, pull),
                gpio.provisionDigitalInputPin(OrangePiZeroPin.GPIO_02, pull),
                gpio.provisionDigitalInputPin(OrangePiZeroPin.GPIO_03, pull),
                gpio.provisionDigitalInputPin(OrangePiZeroPin.GPIO_06, pull),
                gpio.provisionDigitalInputPin(OrangePiZeroPin.GPIO_07, pull),
                gpio.provisionDigitalInputPin(OrangePiZeroPin.GPIO_10, pull),
                gpio.provisionDigitalInputPin(OrangePiZeroPin.GPIO_11, pull),
                gpio.provisionDigitalInputPin(OrangePiZeroPin.GPIO_12, pull),
                gpio.provisionDigitalInputPin(OrangePiZeroPin.GPIO_13, pull),
                gpio.provisionDigitalInputPin(OrangePiZeroPin.GPIO_14, pull),
                gpio.provisionDigitalInputPin(OrangePiZeroPin.GPIO_15, pull),
                gpio.provisionDigitalInputPin(OrangePiZeroPin.GPIO_16, pull),
        };
