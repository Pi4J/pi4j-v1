...
/**
 * <p>
 * This GPIO provider implements the MCP23017 (I2C) and  MCP23S17 (SPI) GPIO expansion board as native Pi4J GPIO pins.
...
public class MCP23x17Pin {
    ...
    public static Pin[] ALL_A_PINS = { MCP23x17Pin.GPIO_A0, MCP23x17Pin.GPIO_A1, MCP23x17Pin.GPIO_A2, MCP23x17Pin.GPIO_A3,
                                       MCP23x17Pin.GPIO_A4, MCP23x17Pin.GPIO_A5, MCP23x17Pin.GPIO_A6, MCP23x17Pin.GPIO_A7 };
    
    public static Pin[] ALL_B_PINS = { MCP23x17Pin.GPIO_B0, MCP23x17Pin.GPIO_B1, MCP23x17Pin.GPIO_B2, MCP23x17Pin.GPIO_B3,
                                       MCP23x17Pin.GPIO_B4, MCP23x17Pin.GPIO_B5, MCP23x17Pin.GPIO_B6, MCP23x17Pin.GPIO_B7 };
    
    public static Pin[] ALL = { MCP23x17Pin.GPIO_A0, MCP23x17Pin.GPIO_A1, MCP23x17Pin.GPIO_A2, MCP23x17Pin.GPIO_A3,
                                MCP23x17Pin.GPIO_A4, MCP23x17Pin.GPIO_A5, MCP23x17Pin.GPIO_A6, MCP23x17Pin.GPIO_A7,
                                MCP23x17Pin.GPIO_B0, MCP23x17Pin.GPIO_B1, MCP23x17Pin.GPIO_B2, MCP23x17Pin.GPIO_B3,
                                MCP23x17Pin.GPIO_B4, MCP23x17Pin.GPIO_B5, MCP23x17Pin.GPIO_B6, MCP23x17Pin.GPIO_B7 };
