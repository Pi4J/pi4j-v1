...
echo "**********************************************************************"
echo "*                                                                    *"
echo "*          BUILDING Pi4J FOR THE 'SINOVOIP BPI' PLATFORM             *"
echo "*                                                                    *"
echo "**********************************************************************"
echo
WIRINGPI_PLATFORM=bpi

# build wiringPi
export WIRINGPI_REPO=https://github.com/BPI-SINOVOIP/WiringPi
...
echo "**********************************************************************"
echo "*                                                                    *"
echo "*     Pi4J JNI BUILD COMPLETE FOR THE 'SINOVOIP-BPI' PLATFORM        *"
echo "*                                                                    *"
echo "**********************************************************************"
echo
tree lib
